...
colnames(alcohol_cons2)[2] = "Gallons" #change column name
alcohol_cons2$Gallons = str_replace(alcohol_cons2$Gallons, "M", "")
alcohol_cons2$Gallons = as.numeric(alcohol_cons2$Gallons)
alcohol_cons2$region <- tolower(alcohol_cons2$State) #create "region" column
alcohol_cons2 = alcohol_cons2[-1] #remove states column
nd = c(2, "nd", "north dakota")
names(nd) = c("Gallons", "abb", "region")
rbind(alcohol_cons2, nd)
